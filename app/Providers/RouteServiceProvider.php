...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        Route::group([
            'middleware' => ['web', 'individual', 'auth:individual'],
            'prefix' => 'individual',
            'as' => 'individual.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/individual.php');
        });
    }

    /**
     * Define the "legal" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapLegalRoutes()
    {
        Route::group([
            'middleware' => ['web', 'legal', 'auth:legal'],
            'prefix' => 'legal',
            'as' => 'legal.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/legal.php');
        });
    }
