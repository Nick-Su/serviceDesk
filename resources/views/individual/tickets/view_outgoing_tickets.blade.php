            ...
            @forelse($tickets as $ticket)
              <tr>
                ...
                <td>
                  ...
                  <a href="/individual/more_info_individual_ticket/{{$ticket->id}}" class="btn btn-info btn-sm">
                    <span class="glyphicon glyphicon-info-sign" title="Подробная информация о заявке"></span>
                  </a>

                  <a href="/individual/confirm_individual_ticket_complete_by_initiator/{{$ticket->id}}" class="btn btn-success btn-sm">
                    <span class="glyphicon glyphicon-ok" title="Отметить заявку как выполненную"></span>                     
                  </a>

                  <a href="/individual/individual_ticket_is_not_complete/{{$ticket->id}}" class="btn btn-danger btn-sm">
...
<script type="text/javascript">
  ...
  {
    $.get({
        url: "/individual/outgoing_tickets",
        cache: false,
        data: {
          "_token": "{{ csrf_token() }}",
        },
